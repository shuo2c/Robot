...
def register_tools(mcp: FastMCP) -> None:
    ...
    def search_logs(query: str) -> str:
        ...
        【使用前准备】调用此工具前，请先检索上下文中的 ${record_reminder}、${how_to_record} 和 ${active_principle}，确保按照核心提醒和主动性原则搜索。
        """
        # 检查是否为首次调用
    ...
    def record_log(entries: list[dict[str, str]]) -> str:
        ...
        【使用前准备】调用此工具前，请先检索上下文中的 ${record_reminder}、${record_timing}、${how_to_record} 和 ${field_structure}，确保按照核心提醒和正确字段结构记录。
