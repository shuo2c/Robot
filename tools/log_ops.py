...
def register_tools(mcp: FastMCP) -> None:
    ...
    def search_logs(query: str) -> str:
        ...
        【使用前准备】调用此工具前，请先检索上下文中的 ${core}、${workflow-rule}、${standard-workflow} 和 ${tools-rules}，确保按照主动记忆规则和工作流程搜索。
        """
        # 检查是否为首次调用
    ...
    def record_log(entries: list[dict[str, str]]) -> str:
        ...
        【使用前准备】调用此工具前，请先检索上下文中的 ${core}、${workflow-rule}、${active-mind} 和 ${tools-rules}，确保按照主动记忆规则和工作流程记录。
